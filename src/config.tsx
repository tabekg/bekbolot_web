...
const SPK_SCREENS = [spkImage, spkScreen1, spkScreen2];

const KERBEN_SCREENS = [kerbenImage, kerbenScreen1, kerbenScreen2];

const BASILICCO_SCREENS = [basiliccoScreen1];
...
export const PROJECTS = [
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Автоматизация и мобильные приложения для логистической компании
          BekCargo.
        </div>
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          ...
          <div>
            ...
            <div className={"mt-3 flex gap-2"}>
              <a
                href={"https://apps.apple.com/kg/app/bekcargo/id6474660949"}
                target={"_blank"}
              ...
              <a
                href={
                  "https://play.google.com/store/apps/details?id=kg.besoft.bekcargo.mobile"
                }
                target={"_blank"}
                rel="noopener noreferrer"
              >
  ...
  },
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Внутренняя программа для автоматизации расчетов с клиентами.
        </div>
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          <div className={"text-right font-medium"}>Основные моменты</div>
          <ul>
        ...
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          ...
          <div>
            ...
            <div className={"mt-3 flex gap-2"}>
              <a
                href={
                  "https://apps.apple.com/kg/app/%D0%BA%D0%B8%D1%82%D0%B5%D0%BF-kg/id6448975741"
                }
                target={"_blank"}
                rel="noopener noreferrer"
              >
              ...
              <a
                href={
                  "https://play.google.com/store/apps/details?id=kg.kitep.mobile"
                }
                target={"_blank"}
                rel="noopener noreferrer"
              >
  ...
  },
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Приложение для логистической компании для отслеживания водителей.
        </div>
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          <div className={"text-right font-medium"}>Основные моменты</div>
          <div>
            ...
            <div className={"mt-3 flex gap-2"}>
              <a
                href={
                  "https://play.google.com/store/apps/details?id=kg.besoft.kerben"
                }
                target={"_blank"}
                rel="noopener noreferrer"
              >
  ...
  },
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Билетный оператор для Узбекстана.
        </div>
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          <div className={"text-right font-medium"}>Основные моменты</div>
          <div>
            ...
            <div className={"mt-3"}>
              <a
                ...
                href={"https://showgo.uz"}
                target={"_blank"}
                rel="noopener noreferrer"
              >
                Веб сайт https://showgo.uz
              </a>
            </div>

            <div className={"mt-3 flex gap-2"}>
              <a
                href={"https://apps.apple.com/kg/app/showgo/id6454899255"}
                target={"_blank"}
                rel="noopener noreferrer"
              >
                <img
              ...
              <a
                href={
                  "https://play.google.com/store/apps/details?id=com.kassirKg.showGoUz"
                }
                target={"_blank"}
                rel="noopener noreferrer"
              >
  ...
  },
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Электронное меню для ресторана Basilicco.
        </div>

        <div className={"mt-3 text-center"}>
          <a
            className={"text-blue-700"}
            href={"https://food.besoft.kg/emenu/fsggqq"}
            target={"_blank"}
            rel="noopener noreferrer"
          >
            Веб сайт https://food.besoft.kg/emenu/fsggqq
          </a>
        </div>

        <div className={"my-5 flex items-center gap-3 flex-col"}>
          {BASILICCO_SCREENS.map((g, i) => (
            <img key={i} width={400} src={g} alt={""} />
          ))}
        </div>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Бесплатные доска объявления в Кыргызстане.
        </div>
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          <div className={"text-right font-medium"}>Основные моменты</div>
          <div>
            ...
            <div className={"mt-3 flex gap-2"}>
              <a
                href={
                  "https://play.google.com/store/apps/details?id=kg.vista.som1"
                }
                target={"_blank"}
                rel="noopener noreferrer"
              >
  ...
  },
  {
    ...
    content: (
      <>
        <div className={"text-center my-2 text-gray-700"}>
          Билетный оператор в Кыргызстане.
        </div>
        <div className={"grid md:grid-cols-2 gap-4 grid-cols-1"}>
          <div className={"text-right font-medium"}>Основные моменты</div>
          <div>
            ...
            <div className={"mt-3"}>
              <a
                className={"text-blue-700"}
                href={"https://kassir.kg"}
                target={"_blank"}
                rel="noopener noreferrer"
              >
                Веб сайт https://kassir.kg
              </a>
            </div>
          </div>
        </div>

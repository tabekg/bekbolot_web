...
function Layout() {
  return (
    <>
      <header className="sticky top-0 z-50 bg-[#CED3C5]/90 backdrop-blur border-b border-gray-400/30 shadow-sm">
        <nav className="container mx-auto flex items-center justify-between px-4 py-3">
          <NavLink
            to="/"
            className="text-lg font-semibold text-gray-800 hover:text-[#C68E52] transition-colors"
          >
            Бекболот Тажибаев
          </NavLink>
